...
(function() {
	...
	var echoGroup = widgets.NewQGroupBox2("Echo", nil),
	...
	var validatorGroup = widgets.NewQGroupBox2("Validator", nil),
	...
	var alignmentGroup = widgets.NewQGroupBox2("Alignment", nil),
	...
	var inputMaskGroup = widgets.NewQGroupBox2("Input mask", nil),
	...
	var accessGroup = widgets.NewQGroupBox2("Access", nil),
	...
	echoComboBox.ConnectCurrentIndexChanged(function(index) {
		echoChanged(echoLineEdit, index)
	})
	validatorComboBox.ConnectCurrentIndexChanged(function(index) {
		validatorChanged(validatorLineEdit, index)
	})
	alignmentComboBox.ConnectCurrentIndexChanged(function(index) {
		alignmentChanged(alignmentLineEdit, index)
	})
	inputMaskComboBox.ConnectCurrentIndexChanged(function(index) {
		inputMaskChanged(inputMaskLineEdit, index)
	})
	accessComboBox.ConnectCurrentIndexChanged(function(index) {
		accessChanged(accessLineEdit, index)
	})
	...
	/*
	var myButton = widgets.NewQPushButton2("NewButton", nil)
	myButton.SetObjectName("myNewButton")
	myButton.ConnectClicked(function() {
		if (isInsideBrowser) {
			alert("you clicked " + myButton.ObjectName())
		}
	})
	...
	*/
	...
	var inputMaskChanged = function(inputMaskLineEdit, index) {
		switch (index) {
			...
			case 1:
				inputMaskLineEdit.SetInputMask("+99 99 99 99 99_")
				break
